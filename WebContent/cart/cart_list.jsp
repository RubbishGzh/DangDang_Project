	...
	<head>
		...
		<script type="text/javascript">
			...
			function countTotalPrice(){
				$.ajax({
					url:"${pageContext.request.contextPath}/CartController/getCart.do",
					type:"POST",
			...
			function updateCart(id){
				...
				$.ajax({
					url:"${pageContext.request.contextPath}/CartController/setBookCount.do",
					type:"POST",
						...
						<table class="tabl_buy" id="tbCartItemsNormal">
							...
							<c:forEach var='c' items="${sessionScope.cartList }">
								...
								<tr class='td_no_bord'>
									...
									<td>
										<a href="${pageContext.request.contextPath}/CartController/deleteBook.do?id=${c.bookId}">删除</a>
									</td>
								</tr>
							</c:forEach>
				...
				<c:forEach var='c' items="${sessionScope.cartList2 }">
					<tr>
						...
						<td width="26" class=buy_td_1>
							<a href="${pageContext.request.contextPath}/CartController/restoreBook.do?id=${c.bookId}">恢复</a>
						</td>
						<td width="26" class=buy_td_1>
							<a href="${pageContext.request.contextPath}/CartController/removeBook.do?id=${c.bookId}">彻底删除</a>
						</td>
