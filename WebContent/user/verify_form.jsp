...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<body>
		...
		<%-- <form action="<s:url action="updateUser" namespace="/aa"/>" method="post"> --%>
		<form action="${pageContext.request.contextPath}/ClientController/EmailVerification.do" method="post">
			<div class="validate_email">
				...
				<div class="look_email">
					...
					<h4>
						第二步：输入激活码 &nbsp;<span style="color:red" id="uuid"><s:property value="#session.key" /></span>
					</h4>
					<div class="mess">
						...
						<span id="error" class="no_right">${requestScope.email_error}<s:property value="error"/></span>
					</div>
				</div>
			</div>
		</form>
