	...
	<body>
		...
		<div class="book">
			...
			<div id="left" class="book_left">
				<!-- 发送请求加载所有的分类 -->
				<c:import url="/ProductController/category/selectCategory.do"></c:import>
			</div>
			<!--左栏结束-->
			...
			<div class="book_center">
				...
				<div class="second_c_border1" id="recommend">
					<!-- 发送请求，加载推荐图书 -->
					<c:import url="/ProductController/product/selectRecommed.do"></c:import>
				</div>
				<!--推荐图书结束-->
				
				<div class="book_c_border2" id="new" style="display:none">
					<!-- 发送请求，加载最新上架图书 -->
					<c:import url="/ProductController/product/selectNew.do"></c:import>
				</div>
				...
				<div class="book_c_border2" id="hot">
					<!-- 发送请求，加载热销图书 -->
					<c:import url="/ProductController/product/selectHot.do"></c:import>
				</div>
				<!--热销图书结束-->
			...
			<div class="book_right">
				<div class="book_r_border2" id="__XinShuReMai">
					<div class="book_r_b2_1x" id="new_bang">
						...
						<!-- 发送请求，加载新手热卖榜 -->
						<c:import url="/ProductController/product/selPro_HotBoard.do"></c:import>
		...
		<script type="text/javascript">
			//右侧栏-更多
		  	function more(){
				...
				$.ajax({
					url:"${pageContext.request.contextPath}/ProductController/product/selectHotBoardMore.do",
					type:"post",
					success:function(data){
						 if(data){
							$.each(data,function(index,value){
								var dd_product_id = value.dd_product_id;
								$("#moreList").prepend("<li>"+
										"<a target='_blank' href='${pageContext.request.contextPath }/product/selectById.do?ddProductId="+dd_product_id+"   '>"
										+value.dd_product_name+
										"</a></li>"); 
